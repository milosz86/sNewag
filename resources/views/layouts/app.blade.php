          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="{{ URL::to('parts/create') }}">-> Dodaj część do Bazy</a></li>
                <li><a href="{{ URL::to('shipments') }}">Wszystkie Przesłane/Wykorzystane</a></li>
                <li><a href="{{ URL::to('shipments/create') }}">-> Zmień Stan Magazynowy</a></li>
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Samochody<span class="caret"></span></a>
              <ul class="dropdown-menu">
            ...
            @else
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                  {{ Auth::user()->name }}&nbsp{{Auth::user()->surname}} <span class="caret"></span>
                </a>
